...
#bot = discord.Bot(debug_guilds=[581194256681664534])
bot = commands.Bot(command_prefix=',', case_insensitive=True, intents=intents, debug_guilds=[581194256681664534, 786371836845490186])
...
#bot.load_extension("cogs.slash_cog")

@bot.event
async def on_connect():
	await bot.sync_commands()
	bot.printDebugMessages = True
